...
(() => {
  ...
  /* ── CONTACT FORM — handled by Formspree Ajax CDN ───────── */
  // Formspree manages submission, validation errors & success state.
  // No manual handler needed. See <script> block at bottom of HTML.
  if (false) { // kept for reference only
  });
